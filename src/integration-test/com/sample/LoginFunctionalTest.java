...
public class LoginFunctionalTest {
	...
	public void loginSuccess() {
        ...
        email.sendKeys("shyamrao.rahul@wipro.com");
        pass.sendKeys("1234");
        button.click();
	...
	public void loginFail() {
        driver.get("http://localhost:6080/OnlineGroceryStore");
        WebElement email = driver.findElement(By.name("email"));
        WebElement pass = driver.findElement(By.name("password"));
        WebElement button = driver.findElement(By.xpath("/html/body/form/div/button"));         
        email.sendKeys("chinmayee.kar@wipro.com");
	...
	public void registrationSuccess() {
        driver.get("http://localhost:6080/OnlineGroceryStore/register.jsp");
	...
	public void forgotPasswordSuccess() {
        driver.get("http://localhost:6080/OnlineGroceryStore/forgotpassword.jsp");
        ...
        email.sendKeys("shyamrao.rahul@wipro.com");
        button.click();
        assertTrue(driver.getPageSource().contains("Vegetable Store"));
	}
}
